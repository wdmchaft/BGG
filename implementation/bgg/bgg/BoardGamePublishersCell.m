...
@implementation BoardGamePublishersCell

+ (NSString *) detailsLabelBuilder:(DBBoardGame *)boardGame
{
    NSString* result = nil;
    
    for(DBPerson *publisher in boardGame.publishers) {
        if(result == nil)
...
+ (CGFloat) calculateTitleHeight:(DBBoardGame *)boardGame
{
    ...
    //titleSize
    CGSize titleLabelSize = [@"Publishers" sizeWithFont:[UIFont systemFontOfSize:TITLE_FONT_SIZE] constrainedToSize:constraint lineBreakMode:UILineBreakModeWordWrap];
...
+ (CGFloat) calculateDetailsHeight:(DBBoardGame *)boardGame
{
    ...
    //detailsSize
    CGSize detailsLabelSize = [[BoardGamePublishersCell detailsLabelBuilder:boardGame] sizeWithFont:[UIFont systemFontOfSize:DETAILS_FONT_SIZE] constrainedToSize:constraint lineBreakMode:UILineBreakModeWordWrap];
...
{
    CGFloat titleHeight = [BoardGamePublishersCell calculateTitleHeight:boardGame];
    
    CGFloat detailsHeight = [BoardGamePublishersCell calculateDetailsHeight:boardGame];
...
-(void) setBoardGame:(DBBoardGame *)boardGame
{
    ...
    [[self textLabel] setText:@"Publishers"];
    
    NSString* result = [BoardGamePublishersCell detailsLabelBuilder:boardGame];
...
- (void) layoutSubviews {
    ...
    CGFloat titleHeight = [BoardGamePublishersCell calculateTitleHeight:_boardGame];
    ...
    CGFloat mechanicsHeight = [BoardGamePublishersCell calculateDetailsHeight:_boardGame];
